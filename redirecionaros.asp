...
correio.send "suporteinf116@sp.senai.br (Sistema de OS)", request.form("solicemailfr"), assunto, "Este correio foi enviado automaticamente pelo programa de OS, por favor não responder.", 2
